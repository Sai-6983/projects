...
from flask import Flask, Response, jsonify,request  #jsonify used to convert output into json formate to display on html page
...
@app.route('/video')
def video():
    return Response(generate_frames(path_x='../Videos/trafficlight.mp4'), mimetype='multipart/x-mixed-replace; boundary=frame')
